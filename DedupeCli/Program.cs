    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                {
                    Dedupe = new DedupeLibrary(IndexFile, MinChunkSize, MaxChunkSize, ShiftCount, BoundaryCheckBytes, WriteChunk, ReadChunk, DeleteChunk, Debug, false);
                    if (Debug) Console.WriteLine("Successfully wrote new index: " + IndexFile);
                    return;
                }
                ...
                Dedupe = new DedupeLibrary(IndexFile, WriteChunk, ReadChunk, DeleteChunk, Debug, false);
        ...
        static void Usage(string msg)
        {
            ...
            Console.WriteLine("  --debug             Enable debug logging to the console");
